...
public partial class DBVENTAContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C2EDA3211");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F9AC2D673");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483BD8261F1");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1072158B54F");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E6F4C74E2");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132200F5FB7");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76AACF9424");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D84BA287F4");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE53BDFBA9");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6CCD9818E");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56141A7039D7");
            ...
            entity.HasOne(d => d.IdTipoDocumentoVentaNavigation).WithMany(p => p.Venta)
                ...
                .HasConstraintName("FK__Venta__idTipoDoc__5441852A");
