...
namespace SistemaVenta.BLL.Implementacion
{
    public class UsuarioService : IUsuarioService
    {
        ...
        private readonly IGenereicRepository<Usuario> _repositorio;
        private readonly IFireBaseService _firebaseService;
        private readonly IUtilidadesService _utilidadesService;
        private readonly ICorreoService _correoService;

        public UsuarioService(
            IGenereicRepository<Usuario> repositorio,
        ...
        public async Task<bool> GuardarPerfil(Usuario entidad)
        {
            ...
            try
            {
                Usuario usuario_enconrado = await _repositorio.Obtener(u => u.IdUsuario == entidad.IdUsuario);

                if(usuario_enconrado == null)
                    throw new TaskCanceledException("El usuario no existe");

                usuario_enconrado.Correo = entidad.Correo;
                usuario_enconrado.Telefono = entidad.Telefono;

                bool respuesta = await _repositorio.Editar(usuario_enconrado);
