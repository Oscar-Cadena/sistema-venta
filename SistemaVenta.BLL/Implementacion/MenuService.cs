...
namespace SistemaVenta.BLL.Implementacion
{
    ...
    {
        private readonly IGenereicRepository<Menu> _repositorioMenu;
        private readonly IGenereicRepository<RolMenu> _repositorioRolMenu;
        private readonly IGenereicRepository<Usuario> _repositorioUsuario;

        public MenuService(
            IGenereicRepository<Menu> repositorioMenu,
            IGenereicRepository<RolMenu> repositorioRolMenu,
            IGenereicRepository<Usuario> repositorioUsuario)
        {
