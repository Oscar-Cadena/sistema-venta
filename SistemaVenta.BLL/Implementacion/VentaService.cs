...
namespace SistemaVenta.BLL.Implementacion
{
    public class VentaService : IVentaService
    {
        ...
        public VentaService(IGenereicRepository<Producto> repositorioProducto, IVentaRepository repositorioVenta)
        {
        ...
        public async Task<List<Venta>> Historial(string numeroVenta, string fechaInicio, string fechaFin)
        {
            ...
            if(fechaInicio != "" && fechaFin != "") {
                DateTime fecha_inicio = DateTime.ParseExact(fechaInicio, "dd/MMMM/yyyy", new CultureInfo("es-MX"));
                DateTime fecha_fin = DateTime.ParseExact(fechaFin, "dd/MMMM/yyyy", new CultureInfo("es-MX"));
