...
namespace SistemaVenta.BLL.Implementacion
{
    ...
    {
        private readonly IGenereicRepository<Producto> _repositorio;
        private readonly IFireBaseService _firebaseServicio;

        public ProductoService(IGenereicRepository<Producto> repositorio, IFireBaseService firebaseServicio)
        {
