...
namespace SistemaVenta.BLL.Implementacion
{
    ...
    {
        private readonly IGenereicRepository<Negocio> _repositorio;
        private readonly IFireBaseService _firebaseService;

        public NegocioService(IGenereicRepository<Negocio> repositorio, IFireBaseService firebaseService)
        {
